@php
    $items = [
        ...
        ['route' => 'admin.payment-methods.index', 'label' => __('admin.menu.payment_methods'), 'icon' => 'payment', 'patterns' => ['admin.payment-methods.*']],
        ...
        ['route' => 'admin.password-change-requests.index', 'label' => __('admin.menu.password_requests'), 'icon' => 'password', 'patterns' => ['admin.password-change-requests.*']],
        ...
        ['route' => 'admin.promotions.index', 'label' => __('admin.menu.promotions'), 'icon' => 'promotions', 'patterns' => ['admin.promotions.*']],
